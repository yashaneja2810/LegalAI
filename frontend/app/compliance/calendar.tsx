  ...
  return (
    <div className="min-h-screen bg-[#F8F3EE] p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-[#2A2A2A] mb-1">Compliance Calendar</h1>
          <p className="text-[#8B7355]">Track all your compliance deadlines and events in one place</p>
        </div>
      ...
      {/* Calendar Views */}
      <div className="bg-white rounded-xl shadow legal-shadow border border-[#D1C4B8] p-6">
        {view === "month" && (
          <div>
            {/* Month grid mockup */}
